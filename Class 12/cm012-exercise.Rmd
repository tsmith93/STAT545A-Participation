...
#fct_c automatically adds both levels together
...
```{r, fig.width=4, fig.height=1.5}
cont %>% 
  #Reorders based on how frequently it appears
  fct_infreq() %>% 
  qplot()
...
gap_asia_2007$country %>% 
  fct_relevel("Syria", "Indonesia", after=2) %>% #choosel location of factor
  levels() %>% 
  head()
```
