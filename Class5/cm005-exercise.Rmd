...
select(gapminder, lifeExp, year, country)
```
...
```{r}
gapminder %>% 
    filter((country =="Canada" | country == "Aleria") & year>=1960 & year < (1970)
gapminder %>% 
  filter(country %>%  c("Canada, Algeria"),
    year >= 1960, year < 1970)
```
