...
course[-1]
course[2]
#r not making changes to original vector
```
...
```{r}
names(course) <- c("subject", "course", "section")
names(course)
course
```
...
#first car of train
my_list[2]
#contents of first car
my_list[[2]]
#sheds lsit structure
my_list[[2]][1] #subset of vector
```
...
#for dataframes, each list can oontain different data types
```
