...
output:
  html_document:
    df_print: paged
editor_options:
  chunk_output_type: github_document
---
...
p_scales + 
    scale_x_log10() +
    scale_colour_continuous(trans="log10") #no scale_colour_log10
```
...
#quantitiative vs. sequential colour palette
...
#There is also a scale_fill set of functions
...
ggplot(iris, aes(Sepal.Width, Sepal.Length)) +
     ...
     labs(x = "Sepal Width",
          ...
          title = "Sepal sizes of three plant species") +
    theme_bw() +
    theme(axis.text = element_text(size = 0.16),
...
```{r}
plot_ly(gapminder, 
        #tilda before variables
        #formula with this as your variable
        x = ~gdpPercap, 
        y = ~lifeExp, 
        type = "scatter",
        mode = "markers",
...
#gganimate!!! animate plots, add aesthetic
#shiny? We will go over this in STAT 547
```
